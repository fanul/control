...
<body>
<script type="text/javascript" src="<?php echo base_url(); ?>src/js/ajaxcaridocument.js"></script>
                        ...
                        <div id="content">
                            ...
                            <div class="jquery_tab">
                                ...
                                <div class="content_block">
                                    ...
                                    <!--
                                    <form method="post" action="cCaridocument/doCari"> -->
                                        <p>
                            ...
                            <?php
                                if($this->session->flashdata("sukses")!=null)
                                  include ('content\caridocumentdetail.php');
                            ?>
                                </div>
                        </div><!--end content-->
                      </div><!--end jquery tab-->

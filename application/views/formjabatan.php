                        ...
                        <div id="content">
                            ...
                            <div class="jquery_tab">
                                ...
                                <div class="content_block">
                                    ...
                                    <form method="post" action="<?php if(strcmp($aksi,"add")==0)echo site_url('cJabatan/confirmAdd'); else echo site_url('cJabatan/confirmUpdate');?>">
                                        <p>
                                            <label for="unit nama">Nama Jabatan</label>
                                            <input class="input-medium" type="text" value="<?php if(strcmp($aksi,"edit")==0) echo $tersangka[0]->jabatan_nama; else echo""; ?>" name="jabatan_nama" id="jabatan_nama"/>
                                        </p>

                                        <?php if($aksi=="edit"){ ?>
                                        <input type="hidden" name="jabatan_id" value="<?php echo $tersangka[0]->jabatan_id; ?>">
                                         <?php } ?>
                                        <p class="clearboth">

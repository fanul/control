...
class mTambahkompetensi extends CI_Model{
    ...
    public function  __construct() {
     ...
     function ambilsatu($field,$tersangka,$join=null)
    {
        $this->db->select();
        $this->db->from("kompetensiambil");
        if($join!=null)
            {
            $this->db->join('kompetensi','kompetensiambil.kompetensi_id = kompetensi.kompetensi_id','left');
    ...
    function masuk($kompetensi_id,$kar_nik)
    {
        $masuk = array(
        ...
        $this->db->insert('kompetensiambil',$masuk);
    ...
    function hapus($ambil_id)
    {
        $masuk = array(
                        'ambil_id'=>$ambil_id
            );

        $this->db->delete('kompetensiambil',$masuk);

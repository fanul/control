...
jQuery(document).ready(function(){	 
	...
	jQuery("#date").datepicker(); //datepicker input field and box
        jQuery("#kar_tanggallahir").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)' });
        jQuery("#kar_masukkerja").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)'  });
        jQuery("#kar_tanggallahir").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)'  });
        jQuery("#kar_tanggalpensiun").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)'  });
        jQuery("#kar_tanggallahirpasangan").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)'  });
        jQuery("#kar_tanggalnikah").datepicker({changeMonth: true, changeYear: true, yearRange: '1960:2020', dateFormat: 'yy-mm-dd', appendText: '(yyyy-mm-dd)'  });
